...
@property (assign, nonatomic, getter = isExecuting) BOOL newExecuting;
@property (assign, nonatomic, getter = isFinished) BOOL newFinished;
...
- (void)setFinished:(BOOL)finished {
    ...
    _newFinished = finished;
    [self didChangeValueForKey:@"isFinished"];
}

- (void)setExecuting:(BOOL)executing {
    [self willChangeValueForKey:@"isExecuting"];
    _newExecuting = executing;
