...
- (void) orientFooter
{
    if (self.walkThroughDirection == GHWalkThroughViewDirectionVertical) {
        ...
        if (isRotated) {
            ...
            self.skipButton.frame = CGRectMake(0, self.frame.size.height - 47, self.frame.size.width, 47);
...
//    self.skipButton.backgroundColor = [UIColor colorWithRed:212/255.0 green:11/255.0 blue:41/255.0 alpha:1.0];
    
//    [self.skipButton setBackgroundImage:[UIImage imageNamed:@"Login.jpg"] forState:UIControlStateNormal];
...
- (void) skipIntroduction
{
    [UIView animateWithDuration:0.3 animations:^{
     ...
     [appDelOurParks removeWelcomeVCandShowRootVC];
